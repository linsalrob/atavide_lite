...
Here we present atavide\_lite as a single bash script which has all the commands you need.
...
Take a look at the [steps in atavide_lite.sh](atavide_lite.sh) to see what we do!
